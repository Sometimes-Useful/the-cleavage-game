...
var GcpRegisteredStreamersRepository_1 = require("./infra/repositories/registeredStreamers/GcpRegisteredStreamersRepository");
var GcpDatastore_1 = require("./infra/tech/GcpDatastore");
var gateways = {
...
var gcpDatastore = new GcpDatastore_1.GcpDatastore({
...
var repositories = {
    globalRegisteredStreamers: new GcpRegisteredStreamersRepository_1.GcpGlobalRegisteredStreamersRepository(gcpDatastore),
    globalCleavageDrawPileRepository: new GcpGlobalCleavageDrawPileRepository_1.GcpGlobalCleavageDrawPileRepository(gcpDatastore)
};
