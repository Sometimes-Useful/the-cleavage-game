...
var retreiveRecordSuccess = function (path, entity) { return "\u2714\uFE0F  Entity with key path '".concat(path, "' retreived from datastore: ").concat(JSON.stringify(entity)); };
...
var queryAllRecordsStart = function (kind) { return "\u2699\uFE0F  queryAllRecordsOnGoogleDatastore - ".concat(kind, " "); };
exports.queryAllRecordsStart = queryAllRecordsStart;
var queryAllRecordsSuccess = function (entities, kind) { return "\u2714\uFE0F  ".concat(entities.length, " entities retrieved on kind '").concat(kind, "'."); };
exports.queryAllRecordsSuccess = queryAllRecordsSuccess;
...
var queryRecordsFilter = function (filter) { return "\uD83D\uDD0E ".concat(filter.property).concat(filter.operator, "'").concat(filter.value, "'"); };
