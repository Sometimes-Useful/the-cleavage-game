...
export const theInterfaceGatewayHasAutoplayOptionDisabled = (gherkinPrefix:Gherkin, application:FakeApplication):Test =>
...
export const theInterfaceGatewayHasAutoplayOptionEnabled = (gherkinPrefix:Gherkin, application:FakeApplication):Test =>
