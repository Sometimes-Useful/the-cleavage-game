...
export const theAutoPlayRepositoryHasNextCleavageDate = (gherkinPrefix:Gherkin, expectedNextCleavageDate:Date) => (application:FakeClientApplication):Test =>
...
export const theAutoPlayRepositoryHasAutoPlayInterval = (gherkinPrefix:Gherkin, expectedAutoplayInterval:number) => (application:FakeClientApplication):Test =>
