...
feature(EventType.PLAYER_SUGGEST_CLEAVAGE, [
    scenario('Scenario 1 : With no public cleavage', [
        ...
        application => whenEventOccurs(application, new PlayerSuggestCleavageEvent(player1, new Cleavage(cleavageTitle1))),
        application => theCleavageRepositoryHasPublicCleavages(Gherkin.THEN, application, [new Cleavage(cleavageTitle1)]),
