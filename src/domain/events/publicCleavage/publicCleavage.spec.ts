...
feature(EventType.PUBLIC_CLEAVAGE, [
    scenario('Scenario 1 : With one public cleavage', [
        ...
        application => theInterfaceGatewayHasPlayingSounds(Gherkin.AND_THEN, application.gateways.interface, [new Sound(SoundType.DICE_ROLL)])
    ]),
    ...
    scenario('Scenario 3 : No public cleavages', [
        ...
        application => theCleavageRepositoryHasPublicCleavages(Gherkin.AND_THEN, application.repositories.cleavage, []),
        application => theInterfaceGatewayHasPlayingSounds(Gherkin.AND_THEN, application.gateways.interface, [new Sound(SoundType.ERROR)])
    ])
])
