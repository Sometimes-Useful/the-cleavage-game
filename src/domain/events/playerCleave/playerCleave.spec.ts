...
feature(EventType.PLAYER_CLEAVE, [
    scenario(`Scenario 1 : ${PlayerCleave.LEFT}`, [
        ...
        application => theCleavageRepositoryHasCurrentCleavage(Gherkin.THEN, application.repositories.cleavage, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.LEFT]]))),
        application => theInterfaceGatewayHasCurrentCleavage(Gherkin.AND_THEN, application.gateways.interface, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.LEFT]])))
    ]),
    scenario(`Scenario 2 : ${PlayerCleave.RIGHT}`, [
        ...
        application => theCleavageRepositoryHasCurrentCleavage(Gherkin.THEN, application.repositories.cleavage, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.RIGHT]]))),
        application => theInterfaceGatewayHasCurrentCleavage(Gherkin.AND_THEN, application.gateways.interface, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.RIGHT]])))
    ]),
    scenario(`Scenario 3 : Already ${PlayerCleave.RIGHT} for ${player1} and player cleave ${PlayerCleave.RIGHT}`, [
        application => theInterfaceGatewayHasCurrentView(Gherkin.GIVEN, application.gateways.interface, InterfaceView.CURRENT_CLEAVAGE),
        application => theCleavageRepositoryHasCurrentCleavage(Gherkin.GIVEN, application.repositories.cleavage, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.RIGHT]]))),
        application => whenEventOccurs(application.gateways.event, new PlayerCleaveEvent(player1, PlayerCleave.RIGHT)),
        application => theCleavageRepositoryHasCurrentCleavage(Gherkin.THEN, application.repositories.cleavage, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.RIGHT]]))),
    ...
    scenario(`Scenario 4 : Already ${PlayerCleave.LEFT} for ${player1} and player cleave ${PlayerCleave.LEFT}`, [
        application => theInterfaceGatewayHasCurrentView(Gherkin.GIVEN, application.gateways.interface, InterfaceView.CURRENT_CLEAVAGE),
        application => theCleavageRepositoryHasCurrentCleavage(Gherkin.GIVEN, application.repositories.cleavage, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.LEFT]]))),
        application => whenEventOccurs(application.gateways.event, new PlayerCleaveEvent(player1, PlayerCleave.LEFT)),
        application => theCleavageRepositoryHasCurrentCleavage(Gherkin.THEN, application.repositories.cleavage, new Cleavage(cleavageTitle1, new Map([[player1.username, PlayerCleave.LEFT]]))),
