...
import { whenQueryDrawGlobalCleavageDrawPileOccursThenHasResult } from '../../tests/unitTests/eventGateway'
...
feature(EventType.DRAW_GLOBAL_CLEAVAGE_DRAWPILE, [
    serverScenario('Scenario 1 : With on cleavage on draw pile', [
        ...
        whenQueryDrawGlobalCleavageDrawPileOccursThenHasResult(commonCleavage1()),
    ...
    serverScenario('Scenario 3 : With 0 cleavages on draw pile', [
        ...
        whenQueryDrawGlobalCleavageDrawPileOccursThenHasResult(undefined),
